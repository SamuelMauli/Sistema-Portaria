...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    foreach ($required_fields as $field) {
        if (empty($_POST[$field])) {
            $_SESSION['error'] = "Todos os campos obrigatÃ³rios devem ser preenchidos.";
    ...
    try {
        ...
        if ($stmt->execute()) {
            ...
            throw new Exception("Erro ao agendar reuniÃ£o: " . $stmt->error);
        }
    } catch (Exception $e) {
    ...
    $_SESSION['error'] = "MÃ©todo invÃ¡lido. Somente POST Ã© permitido.";
    header('Location: ../pages/agendar.php');
    exit();
}
?>
